...
|`<clusterName>`
|Go to *Connect Client*. The cluster name is listed in a table at the bottom of the modal window.
...
. Open the Hazelcast {hazelcast-cloud} console.
